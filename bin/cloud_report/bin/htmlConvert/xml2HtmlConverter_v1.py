...
#                     firstH1=False
                ...
                a_pic=pic_p<<a(cl='img-toggle' ,href='src/images/'+pic_name,title=name)
                
                if (type in picTypes ):
                    a_pic<<img(cl=type, src='src/images/'+pic_name, alt=pic_name) 
                else:
                    sys.stdout.write('pic view type of \"%s\" about %s not predefined,\"img-width-max\" will be used\n'%(type,path))
                    a_pic<<img(cl="img-width-max", src='src/images/'+pic_name, alt=pic_name)
...
#                             shutil.copyfile(workDir+'/'+path,dout+'/src/images/'+pic_name)
                    ...
                    imgA=imgLi<<a(cl="img-toggle", href='src/images/'+pic_name ,title=name)
                    imgA<<img(src='src/images/'+pic_name)
