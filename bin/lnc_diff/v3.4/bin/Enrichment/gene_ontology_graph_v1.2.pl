...
$component_file   ||=  $config{component_file}; # 2014-12-12 ~ 
$function_file    ||=  $config{function_file}; # 2014-12-12 ~ 
$process_file     ||=  $config{process_file}; 
#$component_file   ||=  "/share/nas2/genome/cloud_soft/database/GO_Classify/cellular_component.txt"; # 2014-12-12 ~ 
#$function_file    ||=  "/share/nas2/genome/cloud_soft/database/GO_Classify/molecular_function.txt"; # 2014-12-12 ~ 
#$process_file     ||=  "/share/nas2/genome/cloud_soft/database/GO_Classify/biological_process.txt"; # 2014-12-12 ~ 
$foutdir          ||=  './';
$help             ||=  "";
#-------------------------------------------------------------------------------------
&help () if($help);
...
my $dissvg_pl= $config{dissvg_pl} || "/share/nas2/genome/bmksoft/tool/distributing_svg/v4.75/distributing_svg.pl";
my $svgxxx=$config{svg2xxx} ||  "/share/nas2/genome/bmksoft/tool/svg2xxx/v1.0/svg2xxx";
