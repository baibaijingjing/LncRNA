...
# GetOptions
# ------------------------------------------------------------------
my ($flinks,$unigene,$ftest,$od,$protein,$blast,$id,$clade_or_taxid,$lnc,$cfg);
...
&show_log2("step_10: Difference expression genes analysis of lncRNA finished.");
###########################################################
#close LOG;
# ------------------------------------------------------------------
# sub function
...
Program Date:	2015.09.06
 ...
 Description:	This program is used to ......
       Usage:
		...
		-lnc	<file>	novel_lncRNA_target.xls
		-cfg	detail.cfg
		-h		help
