...
#$component_file   ||=  "/share/nas1/wangyj/database/GO/releases20120916/GO_Classify/cellular_component.txt"; # 2012-09-16 ~ 2014-12-12
#$function_file    ||=  "/share/nas1/wangyj/database/GO/releases20120916/GO_Classify/molecular_function.txt"; # 2012-09-16 ~ 2014-12-12
#$process_file     ||=  "/share/nas1/wangyj/database/GO/releases20120916/GO_Classify/biological_process.txt"; # 2012-09-16 ~ 2014-12-12
$component_file   ||=  "/share/nas1/wangyj/database/GO/releases20141211/GO_Classify/cellular_component.txt"; # 2014-12-12 ~ 
$function_file    ||=  "/share/nas1/wangyj/database/GO/releases20141211/GO_Classify/molecular_function.txt"; # 2014-12-12 ~ 
$process_file     ||=  "/share/nas1/wangyj/database/GO/releases20141211/GO_Classify/biological_process.txt"; # 2014-12-12 ~ 
$foutdir          ||=  './';
$help             ||=  "";
#-------------------------------------------------------------------------------------
&help () if($help);
...
my $dissvg_pl="/share/nas2/genome/bmksoft/tool/distributing_svg/v4.75/distributing_svg.pl";
my $svgxxx="/share/nas2/genome/bmksoft/tool/svg2xxx/v1.0/svg2xxx";
...
my $cmd="/share/nas2/genome/biosoft/R/3.1.1/lib64/R/bin/Rscript $Bin/GOClassificationMap2.r --infile $foutdir/$fkey.GO_enrichment.stat.xls --outpath $foutdir --key $fkey ";
print $cmd,"\n";
system $cmd;
