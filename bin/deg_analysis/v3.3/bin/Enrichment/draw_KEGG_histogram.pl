...
# convert svg to png
# --------------------------------------------------------------------
#my $svg_converter="/share/nas1/litc/tools/svg2xxx_release/svg2xxx"; # ~ 2014-12-11
my $svg_converter=$config{svg2xxx} || "/share/nas1/yangxh/bin/tools/distributing_svg_4.74/svg2xxx_release/svg2xxx"; # 2014-12-11 ~ 
