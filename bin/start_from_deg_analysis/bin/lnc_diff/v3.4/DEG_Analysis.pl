...
#	print SH2 "perl $Bin/bin/draw_cor_plot/v1.0/draw_cor_plot.pl -treated $treated -control $control -all $dir/$group_name.final.xls -o $dir/$group_name.cor.png \n";
	...
	if (defined $enrich) {
		...
		print SH1 "perl $Bin/bin/Enrichment/get_lnc_target_gene_cis.pl -l $dir/$group_name.DEG_final.xls -tg $cis_tar -out $dir/Cis_Anno_enrichment -k $group_name -m $id2/$group_name/$group_name.final.xls  \n\n";
