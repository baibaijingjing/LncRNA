...
p <- p + theme(legend.key.size=unit(0.5, "cm")) + theme_bw()
p <- p + labs(x="Function Class", title="COG Function Classification of Consensus Sequence")+theme(plot.title = element_text(size =10))
