...
#$cmd = "/share/nas2/genome/biosoft/R/3.1.1/lib64/R/bin/Rscript $Bin/bin/fpkm_cor_plot.r $gene_exp_count $outdir ";
$cmd = "$config{Rscript} $Bin/bin/fpkm_cor_plot.r $gene_exp_count $outdir ";
