...
print OUT "#Gene name\tPortein name in COG\tE_value\tIdentity\tScore\tOrganism\tCOG id\tCOG class defination\tFunction code\tFunctional categories\tFunction class defination\n" unless (defined $Nohead);
while (<IN>) {
	my @t = split /\t/;
