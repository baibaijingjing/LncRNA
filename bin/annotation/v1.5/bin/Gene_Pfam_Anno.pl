...
# GetOptions
# ------------------------------------------------------------------
my ($idir, $pfam_db, $cpu_threads_num, $odir,$queues);
...
chomp(my $wd=`pwd`);
$odir            ||= $wd;
#$pfam_db         ||= "/share/nas2/database/pfam/27.0/Pfam-A.hmm";
$cpu_threads_num ||= 4;
$queues||="general.q";
...
#my $TransDecoder = "/share/nas1/yangxh/research/kit/TransDecoder/TransDecoder.pl";
