...
my $ConvertSVGtoPNG=$config{svg2xxx2};
...
my $TILE="KOG Function Classification of Consensus Sequence";
...
`$config{Rscript} $Bin/kog_anno_plot.r $fIn.stat $fOut `;
...
sub USAGE {#
	my $usage=<<"USAGE";
Program: KogFunClassDrawer.pl
Version: $version
Contact: Li Tiancheng <litc\@biomarker.com.cn> <ltc_gs\@qq.com>
Revised: Yangsh <2011-07-20>
Description:
	Make KOG Annotation Classify Graph

Usage:
  Options:
  -i <file>  input kog annotation result file, forced
