...
open (OUT2,">$od/$index.Intro.xls") or die $!;
...
close OUT;
#`/share/nas2/genome/biosoft/R/3.1.1/bin/Rscript  $od/$index.randcheck_num.list $od/$index.randcheck_num.png`;
...
close OUT;
#`/share/nas2/genome/biosoft/R/3.1.1/bin/Rscript $Bin/plot_randcheck_v0.R infile=$od/$index.randcheck_per.list outfile=$od/$index.randcheck_per.png`;#2015/08/10 modify by niulg
#`perl /share/nas2/genome/bmksoft/tool/distributing_svg/v4.75/distributing_svg.pl $od/$index.randcheck_per.list $od/$index.randcheck_per.svg`;#2015/08/10 modify by niulg
#`/share/nas2/genome/bmksoft/tool/svg2xxx/v1.0/svg2xxx $index.randcheck_per.svg`;#2015/08/10 modify by niulg
#system "perl $Bin/draw_total_random.pl -id $od -od $od  ";
#######################################################################################
