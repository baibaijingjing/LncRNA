...
print OUT "p<-ggplot(data=type,aes(x=Sample,y=Percent,fill=Type))+ geom_bar(position='fill',stat=".'"identity"'.",alpha=0.6)+ theme_classic()+theme(panel.border = element_rect(colour = ".'"black"'.", fill=NA, size=0.5)) \n";
