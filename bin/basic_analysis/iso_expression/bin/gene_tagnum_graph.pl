...
chdir $od;
`perl /share/nas2/genome/bmksoft/tool/distributing_svg/v4.75/distributing_svg.pl $out_name.gene_tag.list  $out_name.gene_tag.svg` ;
`/share/nas2/genome/bmksoft/tool/svg2xxx/v1.0/svg2xxx $out_name.gene_tag.svg `;
