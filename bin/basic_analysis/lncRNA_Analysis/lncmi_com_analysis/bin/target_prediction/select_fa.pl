...
sub system_Latin{
	...
	if ($system=~m/Chromalveolata/i) {
		...
		$Litan="cre|pta|ppt|smo|ath|bna|bol|bra|cpa|gma|lja|mtr|vun|ghb|ghr|gra|ptc|sly|vvi|osa|sbi|sof|tae|zma|pvu|mdm|bdi|aqc|peu|csi|ccl|crt|ctr|rco|gar|aly|ahy|gso|pab|ttu|ata|hvu|far|bgy|bcy|tcc|rgl|cme|ssp|amg|aau|ssl|stu";
	}elsif($system=~m/Viruses/i) {
		$Litan="bkv|ebv|hcmv|hiv1|hsv1|jcv|kshv|mcmv|mcv|mdv1|mdv2|mghv|rlcv|rrv|sv40|hsv2|hbv|iltv|hvt|bhv1|bpcv1|bpcv2|hvsa";
	}
