...
my @inBam_split;
my @inBam_recal;
&RM("$dOut/work_sh/GroupRead.sh");
&RM("$dOut/work_sh/ReorderSam.sh");
&RM("$dOut/work_sh/MarkDup.sh");
&RM("$dOut/work_sh/SplitNTrim.sh");
...
&RM("$dOut/work_sh/RealignerTargetCreator.sh");
&RM("$dOut/work_sh/IndelRealigner.sh");
...
&RM("$dOut/work_sh/BaseRecalibrator.sh");
&RM("$dOut/work_sh/PrintReads.sh");
...
if($step==1){
	...
	&qsubOrDie("$dOut/work_sh/CreatIndex.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/CreatIndex.sh");
	$step++ if ($auto==1);
}if($step==2){
	&qsubOrDie("$dOut/work_sh/GroupRead.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/GroupRead.sh");
	$step++ if ($auto==1);
}if($step==3){
    &qsubOrDie("$dOut/work_sh/ReorderSam.sh",$queue,$cpu,$vf);
    &qsubCheck("$dOut/work_sh/ReorderSam.sh");
	&qsubOrDie("$dOut/work_sh/MarkDup.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/MarkDup.sh");
	$step++ if ($auto==1);
}if($step==4){
	&qsubOrDie("$dOut/work_sh/SplitNTrim.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/SplitNTrim.sh");
	$step++ if ($auto==1);
}if($step==5){
	if($doINDEL!=0){
		&qsubOrDie("$dOut/work_sh/RealignerTargetCreator.sh",$queue,$cpu,$vf);
		&qsubCheck("$dOut/work_sh/RealignerTargetCreator.sh");
		&qsubOrDie("$dOut/work_sh/IndelRealigner.sh",$queue,$cpu,$vf);
		&qsubCheck("$dOut/work_sh/IndelRealigner.sh");
		for my $inBam (@inBam){
	...
	if ($doRecal==1) {
	&qsubOrDie("$dOut/work_sh/VariantCalling1.sh",$queue,$cpu,$vf);
	&check_nct_undo_reqsub("$dOut/work_sh/VariantCalling1.sh");
	&qsubOrDie("$dOut/work_sh/VariantCombine1_1.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/VariantCombine1_1.sh");
	&qsubOrDie("$dOut/work_sh/VariantCombine1_2.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/VariantCombine1_2.sh");
	&qsubOrDie("$dOut/work_sh/VariantConvert1.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/VariantConvert1.sh");
	&qsubOrDie("$dOut/work_sh/VariantFiltration1.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/VariantFiltration1.sh");
	...
	if ($doRecal==1) {
	&qsubOrDie("$dOut/work_sh/BaseRecalibrator.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/BaseRecalibrator.sh");
	&qsubOrDie("$dOut/work_sh/PrintReads.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/PrintReads.sh");
	}
	$step++ if ($auto==1);
}if($step==8){
	if ($doRecal==0) {
	...
	&qsubOrDie("$dOut/work_sh/VariantCalling2.sh",$queue,$cpu,$vf);
	&check_nct_undo_reqsub("$dOut/work_sh/VariantCalling2.sh");
	&qsubOrDie("$dOut/work_sh/VariantCombine2_1.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/VariantCombine2_1.sh");
	&qsubOrDie("$dOut/work_sh/VariantCombine2_2.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/VariantCombine2_2.sh");
	&qsubOrDie("$dOut/work_sh/VariantConvert2.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/VariantConvert2.sh");
	&qsubOrDie("$dOut/work_sh/VariantFiltration2.sh",$queue,$cpu,$vf);
	&qsubCheck("$dOut/work_sh/VariantFiltration2.sh");
...
#													"-pairHMM VECTOR_LOGLESS_CACHING", # new feature in GATK 3.1+ for HaplotypeCaller ,but works with 2.6.30 kernel in the official suggestions
		...
		if(@list_files>=30){
			$cmd2_1.=" sh $config{qsub_sh}  $dOut/work_sh/${num}_VariantCombine${index}_11.sh --queue  $queue  --maxproc $cpu --resource vf=$vf --reqsub --independent &&";
			$cmd2_1.=" sh $config{qsub_sh}  $dOut/work_sh/${num}_VariantCombine${index}_12.sh --queue  $queue  --maxproc $cpu --resource vf=$vf --reqsub --independent \n";
		}
		my $Java_tmp="$_java_/CombineGVCFs/All_";
		&MKDIR("$tmppath/CombineGVCFs/All_");
		$cmd2_2="$Java_tmp -jar $_GATK_ -T CombineGVCFs -R $genomeFile -o $vcfname.rawgvcf "; # combine  list gvcf file for all sample
