...
my $cmd = "$config{Rscript} $Bin/bar_split.r --infile $disfile --outfile $outfile --main.col 1 --sub.col 2 --value.col 3 --main.lab \"Length of Indel\" --sub.lab \"Region\" --value.lab \"Number of Indel\" --title.lab \"Indel length distribution\" --legend.xpos 0.85 --legend.ypos 0.85" ;
print "$cmd\n";
&run_or_die($cmd);
